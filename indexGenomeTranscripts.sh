...
curl ftp://ftp.wormbase.org/pub/wormbase/species/c_elegans/PRJNA13758/sequence/genomic/c_elegans.PRJNA13758.${genomeVer}.genomic.fa.gz -o ${GENOME_DIR}/sequence/c_elegans.PRJNA13758.${genomeVer}.genomic.fa.gz

grep "^>" <(gunzip -c  ${GENOME_DIR}/sequence/c_elegans.PRJNA13758.${genomeVer}.genomic.fa.gz) | cut -d " " -f 1 > ${GENOME_DIR}/sequence/decoys.txt
...
cat  ${GENOME_DIR}/sequence/c_elegans.PRJNA13758.${genomeVer}.mRNA_transcripts.fa.gz ${GENOME_DIR}/sequence/c_elegans.PRJNA13758.${genomeVer}.genomic.fa.gz > ${GENOME_DIR}/sequence/mRNA_gentrome.fa.gz
...
cat  ${GENOME_DIR}/sequence/c_elegans.PRJNA13758.${genomeVer}.ncRNA_transcripts.fa.gz ${GENOME_DIR}/sequence/c_elegans.PRJNA13758.${genomeVer}.genomic.fa.gz > ${GENOME_DIR}/sequence/ncRNA_gentrome.fa.gz
...
cat  ${GENOME_DIR}/sequence/c_elegans.PRJNA13758${genomeVer}.pseudogenic_transcripts.fa.gz ${GENOME_DIR}/sequence/c_elegans.PRJNA13758.${genomeVer}.genomic.fa.gz > ${GENOME_DIR}/sequence/pseudogenic_gentrome.fa.gz
...
cat  ${GENOME_DIR}/sequence/c_elegans.PRJNA13758.${genomeVer}.transposon_transcripts.fa.gz ${GENOME_DIR}/sequence/c_elegans.PRJNA13758.${genomeVer}.genomic.fa.gz > ${GENOME_DIR}/sequence/transposon_gentrome.fa.gz
