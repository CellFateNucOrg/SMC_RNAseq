...
if(!dir.exists(paste0(outPath,"/wormcat"))) {dir.create(paste0(outPath,"/wormcat"))}
# ## all genes
# sigTables<-list()
# for (grp in groupsOI){
...
if(!dir.exists(paste0(outPath,"/tissue/wormtissue"))) {dir.create(paste0(outPath,"/tissue/wormtissue"))}
...
for (grp in groupsOI){
  subset<-sigGenes[[grp]][sigGenes[[grp]] %in% tissueScores$entrez & !( sigGenes[[grp]] %in% problemIDs) ]
  print(paste(grp,length(subset),"genes"))
  write.table(subset, file=paste0(outPath,"/tissue/wormtissue/",grp,"_upGenes_ENTREZ.txt"), quote=F, row.names=F,col.names=F)
}
...
for (grp in groupsOI){
  subset<-sigGenes[[grp]][sigGenes[[grp]] %in% tissueScores$entrez & !( sigGenes[[grp]] %in% problemIDs) ]
  print(paste(grp,length(subset),"genes"))
  write.table(subset, file=paste0(outPath,"/tissue/wormtissue/",grp,"_downGenes_ENTREZ.txt"), quote=F, row.names=F,col.names=F)
}
...
if(!dir.exists(paste0(outPath,"/tissue/tea"))) {dir.create(paste0(outPath,"/tissue/tea"))}
...
for (grp in groupsOI){
  ...
  sink(file=paste0(outPath,"/runTea.sh"),append=TRUE, type="output")
  cat(paste0("tea -q 0.05 -s ",fileNamePrefix,grp,"_upGenes_WBID.txt ", fileNamePrefix,grp,"_up_tissue tissue\n"))
  cat(paste0("tea -q 0.05 -s ",fileNamePrefix,grp,"_upGenes_WBID.txt ", fileNamePrefix,grp,"_up_phe phenotype\n"))
  cat(paste0("tea -q 0.05 -s ",fileNamePrefix,grp,"_upGenes_WBID.txt ", fileNamePrefix,grp,"_up_go go\n"))
  sink()
}
...
for (grp in groupsOI){
  ...
  sink(file=paste0(outPath,"/runTea.sh"),append=TRUE, type="output")
  cat(paste0("tea -q 0.05 -s ",fileNamePrefix,grp,"_downGenes_WBID.txt ", fileNamePrefix, grp,"_down_tissue tissue\n"))
  cat(paste0("tea -q 0.05 -s ",fileNamePrefix,grp,"_downGenes_WBID.txt ", fileNamePrefix ,grp,"_down_phe phenotype\n"))
  cat(paste0("tea -q 0.05 -s ",fileNamePrefix,grp,"_downGenes_WBID.txt ", fileNamePrefix, grp, "_down_go go\n"))
  sink()
}
