...
for (grp in groupsOI){
  ...
  sink(file=paste0(outPath,"/runTea.sh"),append=TRUE, type="output")
  cat(paste0("tea -q 0.05 -s ",grp,"_upGenes_WBID.txt ", grp,"_up_tissue tissue\n"))
  cat(paste0("tea -q 0.05 -s ",grp,"_upGenes_WBID.txt ", grp,"_up_phe phenotype\n"))
  cat(paste0("tea -q 0.05 -s ",grp,"_upGenes_WBID.txt ", grp,"_up_go go\n"))
  sink()
}
...
for (grp in groupsOI){
  ...
  sink(file=paste0(outPath,"/runTea.sh"),append=TRUE, type="output")
  cat(paste0("tea -q 0.05 -s ",grp,"_downGenes_WBID.txt ", grp,"_down_tissue tissue\n"))
  cat(paste0("tea -q 0.05 -s ",grp,"_downGenes_WBID.txt ", grp,"_down_phe phenotype\n"))
  cat(paste0("tea -q 0.05 -s ",grp,"_downGenes_WBID.txt ", grp, "_down_go go\n"))
  sink()
}
