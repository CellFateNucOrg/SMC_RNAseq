...
for(i in 1:nrow(df)){
	controlName<-paste0("./tracks_rpts/avr_",df$control[i],"_F_ribo0rpts_UniqueMultiple_RPM.bw")
	sampleName<-paste0("./tracks_rpts/avr_",df$sample[i],"_F_ribo0rpts_UniqueMultiple_RPM.bw")
	outName<-paste0("./tracks_rpts/lfc_",df$sample[i],"-",df$control[i],"_F_ribo0rpts_STAR.bw")
	makeRatio(sampleName,controlName,outName)
	controlName<-paste0("./tracks_rpts/avr_",df$control[i],"_R_ribo0rpts_UniqueMultiple_RPM.bw")
	sampleName<-paste0("./tracks_rpts/avr_",df$sample[i],"_R_ribo0rpts_UniqueMultiple_RPM.bw")
	outName<-paste0("./tracks_rpts/lfc_",df$sample[i],"-",df$control[i],"_R_ribo0rpts_STAR.bw")
	makeRatio(sampleName,controlName,outName)
}
