...
fileNames<-paste0(outPath,"/bamSTARrpts/rpts_",sampleNames,"_ReadsPerGene.out.tab")
...
# Import into DESeq2 ------------------------------------------------------
###############################################################-
# For ISR (inwards-stranded-2ndReadSameAsRNA) need counts from column 4
countTable<-NULL
